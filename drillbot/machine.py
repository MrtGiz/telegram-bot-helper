...
class Machine():
    ...
    def __init__(self, bot, update, user_data):
        ...
        # self.photo_message = photo_message
    ...
    def get_data(self):
        ...
        data = {
            ...
            "photo_message": self.info.photo_message,
        }
    ...
    def send_keyboard(self, title, menu_options, options=None, photo=None, caption=None):
        ...
        # edit
        try:
            ### следующий блок кода отвечает за отправку фото отдельным сообщением
            if photo:
                print(f'machine with photo')
                message = self.bot.send_photo(chat_id=self.chat_id(),
                                    photo=photo, caption=caption)
                self.info.photo_message = message
                print(f'machine self.photo_message: {self.info.photo_message}')
            ###
    ...
    def delete_photo_message(self):
        """
        Функция удаляет сообщение с фото при возвращении к текстовому сообщению
        :return:
        """
        print(f" delete message message_id: {self.info.photo_message['message_id']}")
        print(f"delete message chat_id: {self.info.photo_message['chat']['id']}")
        chat_id = self.info.photo_message['chat']['id']
        message_id = self.info.photo_message['message_id']
        self.bot.delete_message(chat_id=chat_id, message_id=message_id)
        self.info.photo_message = None
        print(f'machine message deleted!')
        return True
