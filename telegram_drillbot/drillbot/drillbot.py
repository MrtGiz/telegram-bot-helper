#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""This module contains a class for a drilldown menu drillbot."""
...
class DrillBot():
    """This class is for creating a drilldown menu drillbot."""

    def __init__(self, token, home_state, transitions):
        """Initialize this drillbot with a set of state transitions."""
        self.token = token
    ...
    def _auth_layer(self, bot, update, user_data):
        ...
        if self.allowed_ids and machine.user_id() not in self.allowed_ids:
            ...
            if self.notify_auth_failure:
                ...
                machine.reply("You don't have access to this drillbot. To get access, ask the owner to whitelist your user id: {}".format(machine.user_id()))
